...
import CreateExpenseSheet from "../../(manager)/expense/CreateExpenseSheet";
import TaskExpensesPanel from "@/components/cost-manager/TaskExpensesPanel";
import ExpenseSheetList from "../../(manager)/expense/ExpenseSheetList";
...
function createStyles(
  ...
  return StyleSheet.create({
    ...
    modalNavigationHeaderTopbarNavBar: { flexDirection: "row", justifyContent: "space-between", alignItems: "center", paddingHorizontal: wp(3.5), paddingVertical: hp(1.5), backgroundColor: colors.bgSecondary, borderBottomWidth: 1, borderBottomColor: colors.border },
    ...
    stickyDiscussionAccessoryComposerInputDockBar: { flexDirection: "row", alignItems: "center", backgroundColor: colors.bgSecondary, borderTopWidth: 1, borderTopColor: colors.border, paddingHorizontal: wp(3), paddingVertical: hp(1.2), gap: wp(2) },
    ...
    <Modal visible transparent animationType="slide">
      <SafeAreaView style={{ flex: 1 }}>
        <KeyboardAvoidingView behavior={Platform.OS === "ios" ? "padding" : "height"} style={dialogStyles.modalBlurOverlay}>
          <ScrollView style={dialogStyles.modalDialogContentBox} contentContainerStyle={{ paddingBottom: hp(4), paddingTop: hp(1) }}>
  ...
  return (
    <SafeAreaView style={{ flex: 1, backgroundColor: colors.bgPrimary }}>
      <KeyboardAvoidingView behavior={Platform.OS === "ios" ? "padding" : "height"} style={styles.fullscreenContainer}>
        ...
        <ScrollView style={styles.scrollContainerBodyViewport} contentContainerStyle={{ paddingBottom: hp(5) }}>
          {currentViewMode === "list" && (
        ...
        <Modal visible={isCreateProjectOpen} animationType="slide" presentationStyle="formSheet">
          <SafeAreaView style={{ flex: 1, backgroundColor: "#161b22" }}>
            <View style={[styles.fullscreenModalViewFrameContainer, { backgroundColor: "#161b22" }]}>
              ...
              <ScrollView 
                style={{ padding: wp(4) }} 
                contentContainerStyle={[{ gap: hp(2), paddingBottom: hp(8) }, isTablet && { maxWidth: 640, alignSelf: "center", width: "100%" }]}
              >
                <View>
        ...
        <Modal visible={isCreateTaskOpen} animationType="slide" presentationStyle="formSheet">
          <SafeAreaView style={{ flex: 1, backgroundColor: "#161b22" }}>
            <View style={[styles.fullscreenModalViewFrameContainer, { backgroundColor: "#161b22" }]}>
              ...
              <ScrollView 
                style={{ padding: wp(4) }} 
                contentContainerStyle={[{ gap: hp(1.8), paddingBottom: hp(8) }, isTablet && { maxWidth: 640, alignSelf: "center", width: "100%" }]}
              >
                <View>
        ...
        <Modal visible={isInnerTaskBuilderOpen} animationType="slide" presentationStyle="formSheet">
          <SafeAreaView style={{ flex: 1, backgroundColor: "#161b22" }}>
            <View style={[styles.fullscreenModalViewFrameContainer, { backgroundColor: "#161b22" }]}>
              ...
              <ScrollView 
                style={{ padding: wp(4) }} 
                contentContainerStyle={[{ gap: hp(1.8), paddingBottom: hp(6) }, isTablet && { maxWidth: 640, alignSelf: "center", width: "100%" }]}
              >
                <View>
                  <Text style={dialogStyles.fieldInputLabel}>Task Title *</Text>
        ...
        <Modal visible={showAssigneePickerOverlay} transparent animationType="fade">
          <SafeAreaView style={{ flex: 1 }}>
            <View style={dialogStyles.modalBlurOverlay}>
              <View style={[dialogStyles.modalDialogContentBox, { maxHeight: hp(70), flex: 1 }]}>
                <View style={dialogStyles.modalHeaderContainerRow}>
                ...
                <ScrollView style={{ flex: 1 }} contentContainerStyle={{ paddingBottom: hp(2) }}>
